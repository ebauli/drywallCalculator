...
Partial Public Class drywallDataSet1
    ...
    Partial Public Class DataTable2DataTable
        ...
        Private columnrc_name As Global.System.Data.DataColumn
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public ReadOnly Property rc_nameColumn() As Global.System.Data.DataColumn
            Get
                Return Me.columnrc_name
            End Get
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddDataTable2Row(ByVal room_name As String, ByVal project_id As Integer, ByVal room_id As Integer, ByVal rc_name As String, ByVal lc_name As String, ByVal wall_name As String, ByVal wall_description As String, ByVal lc_id As Integer, ByVal rc_id As Integer, ByVal width As Single, ByVal has_reveal As SByte, ByVal bb_height As Single, ByVal reveal_height As Single, ByVal strip_size As Single) As DataTable2Row
            Dim rowDataTable2Row As DataTable2Row = CType(Me.NewRow,DataTable2Row)
            Dim columnValuesArray() As Object = New Object() {room_name, Nothing, project_id, room_id, rc_name, lc_name, wall_name, wall_description, lc_id, rc_id, width, has_reveal, bb_height, reveal_height, strip_size}
        ...
        Friend Sub InitVars()
            ...
            Me.columnproject_id = MyBase.Columns("project_id")
            Me.columnroom_id = MyBase.Columns("room_id")
            Me.columnrc_name = MyBase.Columns("rc_name")
        ...
        Private Sub InitClass()
            ...
            Me.columnroom_id = New Global.System.Data.DataColumn("room_id", GetType(Integer), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnroom_id)
            Me.columnrc_name = New Global.System.Data.DataColumn("rc_name", GetType(String), Nothing, Global.System.Data.MappingType.Element)
            MyBase.Columns.Add(Me.columnrc_name)
    ...
    Partial Public Class DataTable2Row
        ...
        Public Property rc_name() As String
            Get
                Try 
                    Return CType(Me(Me.tableDataTable2.rc_nameColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'rc_name' in table 'DataTable2' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDataTable2.rc_nameColumn) = value
            End Set
        End Property
        ...
        Public Property lc_name() As String
            Get
                Try 
                    Return CType(Me(Me.tableDataTable2.lc_nameColumn),String)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'lc_name' in table 'DataTable2' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableDataTable2.lc_nameColumn) = value
            End Set
        End Property
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function Isrc_nameNull() As Boolean
            Return Me.IsNull(Me.tableDataTable2.rc_nameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub Setrc_nameNull()
            Me(Me.tableDataTable2.rc_nameColumn) = Global.System.Convert.DBNull
        End Sub
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Function Islc_nameNull() As Boolean
            Return Me.IsNull(Me.tableDataTable2.lc_nameColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub Setlc_nameNull()
            Me(Me.tableDataTable2.lc_nameColumn) = Global.System.Convert.DBNull
        End Sub
...
Namespace drywallDataSet1TableAdapters
    ...
    Partial Public Class DataTable2TableAdapter
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0) = New Global.MySql.Data.MySqlClient.MySqlCommand()
            Me._commandCollection(0).Connection = Me.Connection
            Me._commandCollection(0).CommandText = "SELECT        rooms.room_name, walls.*"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"FROM            rooms INNER JOIN"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"       "& _ 
                "                  walls ON rooms.room_id = walls.room_id"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"WHERE        (walls.pr"& _ 
                "oject_id = @project_id)"
            Me._commandCollection(0).CommandType = Global.System.Data.CommandType.Text
            Dim param As Global.MySql.Data.MySqlClient.MySqlParameter = New Global.MySql.Data.MySqlClient.MySqlParameter()
            param.ParameterName = "@project_id"
